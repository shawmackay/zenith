 ...
 * @author calum
 */
public class MessageBrokerServiceType extends ServiceType{

	
	public String getDisplayName() {
		// TODO Complete method stub for getDisplayName
		return "Zenith Message Broker";
	}
	
	public java.awt.Image getIcon(int param) {
        ImageIcon imic = new ImageIcon(this.getClass().getResource("zenithbroker.png"));
        ImageIcon imicmono = new ImageIcon(this.getClass().getResource("zenithbroker.png"));
